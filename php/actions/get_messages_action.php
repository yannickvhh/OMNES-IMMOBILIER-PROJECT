...
try {
    // Fetch messages between current user and contact_id
    ...
    // Mark messages from contact_id as read
    ...
    echo json_encode($messages); // Output messages as JSON array directly (not wrapped in success/data)
